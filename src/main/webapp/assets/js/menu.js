...
;
	...
	window.addEventListener('load', function() {
	 ...
	 document.getElementById('btn-toggle').addEventListener('click', function(event) {
        ...
        // Seleciona o elemento que contém as classes .layout .sidebar
        var sidebarElement = document.querySelector('.layout .sidebar .sidebar-toggler');
        
        // Alterna a classe .sidebar-toggler
        if (sidebarElement.classList.contains('sidebar-toggler ')) {
            sidebarElement.classList.remove('sidebar-toggler ');
        } else {
            sidebarElement.classList.add('sidebar-toggler');
        }
    });
